...
predicate ExprHasSecType(d:SecDeclarations, e:Expr, t:SecType) { 
...
predicate CommandHasSecTypeBasic(d:SecDeclarations, c:Command, t:SecType) 
    decreases c, 0
{
    //####CodeMarker2Begin####
    match c
        ...
        case IfThenElse(cond, ifTrue, ifFalse) =>
            ...
            ExprHasSecType(d, cond, t) && CommandHasSecType(d, ifTrue, t) && CommandHasSecType(d, ifFalse, t)
...
predicate CommandHasSecType(d:SecDeclarations, c:Command, t:SecType) 
    decreases c, 1
{
